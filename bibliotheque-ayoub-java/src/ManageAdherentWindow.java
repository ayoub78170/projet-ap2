...
public class ManageAdherentWindow extends JFrame {
    ...
    public ManageAdherentWindow() {
        ...
        loadAdherentsCombo();
        adherentsCombo.addActionListener(e -> fillFieldsWithSelectedAdherent());
        ...
        ajouterButton.addActionListener(e -> ajouterAdherent());
        panel.add(ajouterButton, gbc);

        gbc.gridx = 1;
        gbc.gridy = 4;
        JButton modifierButton = createButton("Modifier");
        modifierButton.addActionListener(e -> modifierAdherent());
        panel.add(modifierButton, gbc);

        gbc.gridx = 2;
        gbc.gridy = 4;
        JButton supprimerButton = createButton("Supprimer");
        supprimerButton.addActionListener(e -> supprimerAdherent());
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new ManageAdherentWindow());
    }
}