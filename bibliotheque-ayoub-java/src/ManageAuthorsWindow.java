...
public class ManageAuthorsWindow extends JFrame {
    ...
    public ManageAuthorsWindow() {
        ...
        loadAuthorsCombo();
        auteursCombo.addActionListener(e -> fillFieldsWithSelectedAuthor());
        ...
        gbc.gridx = 0;
        gbc.gridy = 5;
        JButton ajouterButton = createButton("Ajouter");
        ajouterButton.addActionListener(e -> ajouterAuteur());
        panel.add(ajouterButton, gbc);

        gbc.gridx = 1;
        gbc.gridy = 5;
        JButton modifierButton = createButton("Modifier");
        modifierButton.addActionListener(e -> modifierAuteur());
        panel.add(modifierButton, gbc);

        gbc.gridx = 2;
        gbc.gridy = 5;
        JButton supprimerButton = createButton("Supprimer");
        supprimerButton.addActionListener(e -> supprimerAuteur());
    ...
    private JButton createButton(String text) {
        ...
        button.setBackground(new Color(200, 160, 255));
    ...
    private void fillFieldsWithSelectedAuthor() {
        ...
        if (selectedAuthor != null) {
            ...
            try {
                ...
                if (rs.next()) {
                    selectedAuthorId = rs.getInt("id_auteur");
    ...
    private void modifierAuteur() {
        ...
        if (option == JOptionPane.YES_OPTION) {
            try {
                ...
                updateStmt.setInt(5, selectedAuthorId);
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new ManageAuthorsWindow());
    }
}